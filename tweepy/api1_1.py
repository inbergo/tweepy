...
class API(object):
    ...
    mentions = bind_api(
        ...
        allowed_param = ['since_id', 'max_id', 'count'], # page is depricated in 1.1
        require_auth = True
    )


    """ statuses/user_timeline """
    """ it is recommended to use this api with include_rts=1  """
    user_timeline = bind_api(
        path = '/statuses/user_timeline.json',
        payload_type = 'status', payload_list = True,
        allowed_param = ['user_id', 'screen_name', 'since_id',
                          'max_id', 'count', 'exclude_replies', 'trim_user', 'include_rts', 'contributor_details'],
        require_auth = True
    )
    ...
    home_timeline = bind_api(
        ...
        payload_type = 'status', payload_list = True,
        allowed_param = ['count', 'since_id', 'max_id', 'trim_user', 'exclude_replies', 'include_entities', 'contributor_details'],
        require_auth = True
    )
